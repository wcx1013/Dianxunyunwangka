...
public class LoginActivity extends BasePresenterActivity {
    ...
    @OnClick({R.id.logo, R.id.login_phone, R.id.shojihao, R.id.login_securitycode, R.id.code, R.id.verificationcode, R.id.code2, R.id.code3, R.id.code4, R.id.login_btw, R.id.qita, R.id.login_weixin})
