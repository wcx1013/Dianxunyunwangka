...
import com.yd.dengteng.main.fragments.HomeFragment;
import com.yd.dengteng.main.fragments.MeFragment;
import com.yd.dengteng.main.fragments.Tab1Fragment;
import com.yd.dengteng.main.fragments.Tab2Fragment;
import com.yd.dengteng.main.fragments.Tab3Fragment;
...
//                showShoppingCart = true;
    ...
    public MainPagerAdapter(FragmentManager fm) {
        ...
        if (PAGE_CONFIG.showHome) {
            ...
            norIcons[lastIndex] = R.drawable.icon_home_n;
            seleIcons[lastIndex] = R.drawable.icon_home_p;
        }
//        if (PAGE_CONFIG.showClassify) {
//            list.add(new Tab1Fragment());
//            int lastIndex = list.size() - 1;
//            titles[lastIndex] = R.string.main_tab_classify;
//            norIcons[lastIndex] = R.drawable.ic_classify_nor;
//            seleIcons[lastIndex] = R.drawable.ic_classify_sele;
//        }
...
//        }
        if (PAGE_CONFIG.showMe) {
            ...
            norIcons[lastIndex] = R.drawable.icon_mine_n;
            seleIcons[lastIndex] = R.drawable.icon_mine_p;
        }
    }
